...
{
    public class ThucDonTuanResponse
    {
        public List<ThucDonNgayResponse> listThucDonNgay {  get; set; }
        ...
        public ThucDonTuanResponse()
        {
            listThucDonNgay = new List<ThucDonNgayResponse>();
            TongNangLuong = 0;
            TongProtein = 0;
            TongChatBeo = 0;
            TongCarbohydrate = 0;
